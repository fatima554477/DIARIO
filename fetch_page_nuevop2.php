...
<div id="content">
    ...
    <strong>
        <p class="mb-0 text-uppercase">
            <img src="includes/contraer31.png" id="mostrar30" onclick="loadp2(1);" style="cursor:pointer;"/>
...
<div id="target30" style="display:block;" class="content2">
	<div class="card">
		<div class="card-body">
			<!--aqui inicia filtro-->
			<div class="row text-center" id="loaderp2" style="position: absolute;top: 140px;left: 50%"></div>
			<table width="100%" border="0">
				<tr>
<td width="30%" align="center"> 
    <span>MOSTRAR</span>
    <select class="form-select mb-3" id="per_pagep2" onchange="loadp2(1);">
        <option value="7" <?php if($_REQUEST['per_pagep2']=='7') echo 'selected'; ?>>7</option>
        <option value="20" <?php if($_REQUEST['per_pagep2']=='20') echo 'selected'; ?>>20</option>
        <option value="50" <?php if($_REQUEST['per_pagep2']=='50') echo 'selected'; ?>>50</option>
        <option value="100"<?php if($_REQUEST['per_pagep2']=='100')echo 'selected'; ?>>100</option>
        <option value="1000"<?php if($_REQUEST['per_pagep2']=='1000')echo 'selected'; ?>>TODOS</option>
    </select>
</td>

					<td width="30%" align="center">
						<button class="btn btn-sm btn-outline-success px-5" type="button" onclick="loadp2(1);">BUSCAR/RESET</button>
					</td>
					<td width="30%" align="center"> <span>PLANTILLA</span> 
					
					
						<?php
$encabezado = '<select class="form-select mb-3" id="DEPARTAMENTO2WE" required onchange="loadp2(1);">
...
require "clasesp2/script.filtrop2.php";
?>
