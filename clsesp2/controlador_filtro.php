...
$action = (isset($_POST["actionp2"])&& $_POST["actionp2"] !=NULL)?$_POST["actionp2"]:"";
if($action == "ajaxp2"){
...
<?php } ?>
<?php  if($database->plantilla_filtro($nombreTabla,"NUMERO_EVENTO",$altaeventos,$DEPARTAMENTO)=="si"){ ?><td style="text-align:center"><?php $colspan += 1; echo $row['NUM_EVENTO_SUBE'];?></td>
<?php } ?>
...
<td>
<?php if($database->variablespermisos('','PAGOAPROVEEDIARIO','modificar')=='si'){ ?>
...
echo '<script>
    document.getElementById("contador-registros").innerHTML = "<span class=\'circulo-contador\'>' . $numrows . '</span>";
</script>';
    ?>
</div>
	<?php
