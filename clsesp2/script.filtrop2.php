...
/*termina copiar y pegar*/
			...
			$("#loaderp2").fadeIn('slow');
    $.ajax({
        url: 'DIARIO/clasesp2/controlador_filtro.php', 
        type: 'POST',
        data: parametros,
						 beforeSend: function(objeto){
				$("#loaderp2").html("Cargando...").fadeIn().delay(500).fadeOut();
			  },
        success: function (data) {
			
				
		
            $(".datos_ajaxp2").html(data).fadeIn('slow');
