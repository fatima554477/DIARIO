...
<div id="content">     
			<hr/>
		<strong>	  <p class="mb-0 text-uppercase" ><img src="includes/contraer31.png" id="mostrar48" style="cursor:pointer;"/>
<img src="includes/contraer41.png" id="ocultar48" style="cursor:pointer;"/>&nbsp;&nbsp;&nbsp; FILTRO BOTIQUÍN</p></strong></div>
...
<!--aqui inicia filtro-->
            ...
            <div class="row text-center" id="loader78" style="position: absolute;top: 140px;left: 50%"></div>
